...
namespace RectangleRuleIntegration
{
    public partial class Form1 : Form
    {
        ...
        private void goButton_Click(object sender, EventArgs e)
        {
            ...
            double estimated = RectangleRuleIntegrate(F, xmin, xmax, ymin, ymax, numPoints);
            ...
            DrawRectangleRuleIntegration(F, xmin, xmax, ymin, ymax, numPoints);
        }
        ...
        // Draw points for a Monte Carlo integration.
        private void DrawRectangleRuleIntegration(Func<double, double> F,
            double xmin, double xmax, double ymin, double ymax, int numSlices)
        {
